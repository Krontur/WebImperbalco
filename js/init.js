				...
				panels: {
					...
					overlays: {
                                                upBar:{
                                                    ...
                                                    width: '100%',
                                                    height: 'auto',
                                                    html: '<div class="skel-panels-fixed" style="background-color:#222"><img src="images/Logo-2048.png" class="titulonarrow" alt="" /></div>'
                                                },
						sidePanelToggle: {
							breakpoints: 'narrower',
							position: 'top-right',
							...
							html: '<div data-action="togglePanel" data-args="sidePanel" class="toggle"></div>'
                                                ...
                                                topBar:{
                                                    ...
                                                    width: '100%',
                                                    height: 'auto',
                                                    html: '<div data-action="moveElement" data-args="cabecera" class="wide widest normal narrow"></div>'
                                                }
					}
				}
			}
